...
<body class="bg-amber-50">
    ...
    <nav class="bg-zinc-900 text-white px-8 py-4">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="text-2xl font-display font-bold">CoffeEase</div>
        ...
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="grid md:grid-cols-3 gap-8 text-left max-w-4xl mx-auto">
                <div>
                    ...
                    <p class="text-gray-400">Jl. Kopi Nikmat No. 123<br>Surabaya, Indonesia</p>
                </div>
                <div>
                    <div class="text-amber-400 text-2xl mb-2">📞</div>
                ...
                <div>
                    ...
                    <p class="text-gray-400">hello@coffease.com<br>support@coffease.com</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-black text-gray-400 py-8 px-8 text-center">
        <div class="max-w-7xl mx-auto">
            <div class="font-display text-2xl font-bold text-white mb-4">CoffeEase</div>
            <p>&copy; 2024 CoffeEase. All rights reserved.</p>
        </div>
    </footer>
</body>
</html>
